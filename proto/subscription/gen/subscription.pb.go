...
type DueSubscriptionRequest struct {
...
func (x *DueSubscriptionRequest) Reset() {
	*x = DueSubscriptionRequest{}
	mi := &file_proto_subscription_subscription_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DueSubscriptionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DueSubscriptionRequest) ProtoMessage() {}

func (x *DueSubscriptionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_subscription_subscription_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use DueSubscriptionRequest.ProtoReflect.Descriptor instead.
func (*DueSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_proto_subscription_subscription_proto_rawDescGZIP(), []int{0}
}

func (x *DueSubscriptionRequest) GetDueDate() string {
	if x != nil {
		return x.DueDate
	}
	return ""
...
const file_proto_subscription_subscription_proto_rawDesc = "" +
	"\n" +
	"%proto/subscription/subscription.proto\x12\fsubscription\x1a\x1bgoogle/protobuf/empty.proto\"2\n" +
	"\x16DueSubscriptionRequest\x12\x18\n" +
	"\adueDate\x18\x01 \x01(\tR\adueDate2n\n" +
	"\x13SubscriptionService\x12W\n" +
	"\x17ProcessDueSubscriptions\x12$.subscription.DueSubscriptionRequest\x1a\x16.google.protobuf.EmptyB\x12Z\x10subscription/genb\x06proto3"
...
var file_proto_subscription_subscription_proto_goTypes = []any{
	(*DueSubscriptionRequest)(nil), // 0: subscription.DueSubscriptionRequest
	(*emptypb.Empty)(nil),          // 1: google.protobuf.Empty
}
var file_proto_subscription_subscription_proto_depIdxs = []int32{
	0, // 0: subscription.SubscriptionService.ProcessDueSubscriptions:input_type -> subscription.DueSubscriptionRequest
	1, // 1: subscription.SubscriptionService.ProcessDueSubscriptions:output_type -> google.protobuf.Empty
