...
func (m *MockUserRepository) GetOneByEmail(email string) (domains.UserModel, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) GetOneByEmail(email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
